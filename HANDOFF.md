...
- 규격: **86 × 52 mm** (243.78 × 147.40 pt) — 2026-07-30 변경 (원본 파일은 88.5 × 58).
  배치 전략: 상단 요소(이름 블록·주소·우상단 로고)는 상단 앵커, 하단 요소(SLBS®·슬로건·
  뒷면 워드마크)는 하단 앵커 — 위·아래 여백 원본 유지, 가운데 공간만 축소.
  벡터 페이지는 원본 규격(SRC_W/H) 그대로 임베드하고 클립+오프셋으로 배치.
  도련 없음(배경 흰색), 색상 K100 계열
